...
export function InputGroupText({
  ...
  return (
    <div
      ...
      className={cn(
        "input-group-text",
        "flex items-center justify-center border-input border-2 px-3 py-1 text-sm text-muted-foreground",
        !merged &&
